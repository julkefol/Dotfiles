...
//user_pref("browser.search.suggest.enabled", true); //Enable search suggestion
//user_pref("browser.urlbar.suggest.searches", true); //Show search suggestion at URL bar
